...
namespace FrontEnd
{
    public partial class Estoque : Form
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=LAPTOP-KJ1E8U0D/SQL2014;Initial Catalog=tcmrestaurante;User ID=sa;Password=1234567");
...

        {
            try
            {
               ...
               // string strConexao = @"Data source = localhost; Initial Catalog = tcmrestaurante; User = sa; Password = 1234567";
                ...
                string sql = "SELECT codProd,nomeProd,qtdProd,fornProd,descProd FROM estoque";
